...
export const Register = (props) => {
    ...
    return (
        <div className="auth-form-container text-center" style={{margin:"auto" , width:"500px", padding:"71px", marginTop:"20px", marginBottom:"20px"}}>
            <h2>S'inscrire</h2>
            <form className="register-form" onSubmit={handleSubmit}>
                ...
                <Button color="success" style={{ marginTop: '20px' , padding:"15px", borderRadius:"3"}} type="submit" onClick={save}>
                    S'inscrire
                </Button>
            </form>
            <button className="link-btn" ><a href={"/login"}>Vous vous ête déjà inscrits ? Veuillez vous authentifier</a></button>
        </div>
    );
};